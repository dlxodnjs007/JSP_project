                ...
                <div class="board-wrap">
                    ...
                    <div class="board-list">
						...
						<div class="post-btn-wrap">
							...
							<div class="btn-right">
								<a href="./write.jsp" class="btn-default"><span>쓰기</span></a>
							</div>
							<div class="paginate">
								...
								<a href="javascript:;" onclick="searchList(2)">2</a> <a
									...
									href="javascript:;" onclick="searchList(4)">4</a> <a
									href="javascript:;" onclick="searchList(5)">5</a> <a
									href="javascript:;" onclick="searchList(6)">6</a> <a
									href="javascript:;" onclick="searchList(7)">7</a> <a
									...
									href="javascript:;" onclick="searchList(11)" class="next">다음<span></span></a>
