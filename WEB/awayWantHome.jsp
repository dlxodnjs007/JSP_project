...
<head>
    ...
    <script>
        function goPopupShowGame(game_id){
            var pop = window.open("/AwayToHome.jsp?id=" + game_id,"pop","width=600,height=670, scrollbars=yes, resizable=yes, left=200, top=200");
        }
    </script>
</head>
<body>
        ...
        <div id="container">
            ...
            <div id="content-wrap">
                ...
                <%
                        ...
                        for(int i = 0; i < listHWA.size(); i++) {
                            if((awayApplyDAO.checkApply(listHWA.get(i).getId(), user_id)) == false) {
                %>
