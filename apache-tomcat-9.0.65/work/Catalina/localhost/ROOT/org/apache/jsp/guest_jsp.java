 ...
 * Generated at: 2022-12-11 01:38:36 UTC
...
import game.PickupDAO;
import game.Pickup;
import game.PickupApply;
import game.PickupApplyDAO;
...
public final class guest_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("game.Pickup");
    _jspx_imports_classes.add("game.PickupApply");
    _jspx_imports_classes.add("game.PickupApplyDAO");
    _jspx_imports_classes.add("game.PickupDAO");
 ...
 request.setCharacterEncoding("UTF-8"); 
      ...
      out.write("    <script>\r\n");
      out.write("        function goPopupShowPickup(game_id){\r\n");
      out.write("            var pop = window.open(\"/showPickupNotApproved.jsp?id=\" + game_id,\"pop\",\"width=600,height=670, scrollbars=yes, resizable=yes, left=200, top=200\");\r\n");
      out.write("        }\r\n");
      out.write("        function goPopupShowPickupApproved(game_id){\r\n");
      out.write("            var pop = window.open(\"/showPickupApproved.jsp?id=\" + game_id,\"pop\",\"width=600,height=670, scrollbars=yes, resizable=yes, left=200, top=200\");\r\n");
      out.write("        }\r\n");
      out.write("    </script>\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      ...
      out.print(listP.get(j).getId_no());
      out.write("\" onclick=\"goPopupShowPickup(this.value)\">\r\n");
      out.write("                            ");
      out.print(listP.get(j).getRoadAddrPart1());
      out.write("\r\n");
      out.write("                            —&nbsp");
      out.print(listP.get(j).getDate().substring(0,9));
      out.write("\r\n");
      out.write("                            —&nbsp");
      out.print(listP.get(j).getDate().substring(11,12));
      out.write("시\r\n");
      out.write("                            ");
      out.print(listP.get(j).getDate().substring(14,15));
      out.write("분\r\n");
      out.write("                        </button>\r\n");
      out.write("                    </div>\r\n");
      out.write("                    ");
      ...
      out.write("\r\n");
      out.write("                </div> \r\n");
      out.write("                <div class=\"pickup-approve\">\r\n");
      out.write("                    <hr>\r\n");
      out.write("                    승인 완료\r\n");
      out.write("                    ");
      ...
      out.write("                    <div class=\"game-exist\">\r\n");
      out.write("                        <button type=\"button\" class=\"game-exist-btn\" value=\"");
      out.print(acceptedlistP.get(j).getId_no());
      out.write("\" onclick=\"goPopupShowPickupApproved(this.value)\">\r\n");
      out.write("                            ");
      out.print(acceptedlistP.get(j).getRoadAddrPart1());
      out.write("\r\n");
      out.write("                            |&nbsp");
      out.print(acceptedlistP.get(j).getDate().substring(0,9));
      out.write("\r\n");
      out.write("                            |&nbsp");
      out.print(acceptedlistP.get(j).getDate().substring(11,12));
      out.write("시\r\n");
      out.write("                            ");
      out.print(acceptedlistP.get(j).getDate().substring(14,15));
      out.write("분\r\n");
      out.write("                        </button>\r\n");
      out.write("                    </div>\r\n");
      out.write("                    ");
      ...
      out.write("                    <button type=\"button\" onclick=\"location.href='./guestWantHome.jsp'\">게스트 신청하기</button>\r\n");
      out.write("                </div>\r\n");
      out.write("            </div>\r\n");
      out.write("            <!-- //본문 -->\r\n");
      out.write("            \r\n");
